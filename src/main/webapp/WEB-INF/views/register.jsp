        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="card card-container">
                    <div class="card-body">
                        <h3 class="card-title text-center register-title">Register Here!</h3>
                        ...
                        <form:form action="save" method="post" modelAttribute="user" class="register-form">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color: blue; color: white;">Register</button>
                        </form:form>
                    </div>
                </div>
            </div>
